"""CSC108H1 Fall 2025: Mystery Message Game.
...
from mm_functions import (VOWEL_COST, CONSONANT_BONUS, PLAYER_ONE,
...
def play_game(message: str, messages: list[str], game_type: str) -> None:
    ...
    while not mmf.is_game_over(view, message, move):
        ...
        if move == QUIT:
            ...
            consonants = mmf.remove_at_index(consonants, 
                consonants.find(guess))
            vowels = mmf.remove_at_index(vowels, vowels.find(guess))
